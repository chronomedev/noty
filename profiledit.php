		...
		<div class="container-fluid">
                ...
                <form>
                    ...
                    <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="last_name"placeholder="Enter Your Last Name" value="">
                            </div>
                            <div class="form-group col-md-12">
                                    <label for="username">Username</label>
                                    <input type="text" class="form-control" id="username"placeholder="Enter Your username" value="">
                                    </div>
                                    <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                    ...
                                                    <input type="password" class="form-control" id="old-password"placeholder="Enter Your Old Password" value="">
                                                    </div>
                                    
                                                    <button type="button" class="btn btn-lg btn-primary addnew" style="margin: 10px;">Save Changes</button>
